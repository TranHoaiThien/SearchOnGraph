...
from search_algorithm import BFS, example_func, DFS, AStar, UCS, HillClamping, Dijkstra, Greedy
...
def run(graph, start, goal, search_alg=None):
    ...
    if search_alg == 'bfs':
        ...
        Dijkstra(global_graph, edges, edge_id, start, goal)
    elif search_alg == 'hillclamping':
        HillClamping(global_graph, edges, edge_id, start, goal)
